...
export default function Navbar({ title, setIsOpen }) {
  ...
  return (
    <header className="bg-[#00A389] text-white px-6 py-3 flex items-center justify-between sticky top-0 z-20 shadow-sm border-b border-black/5 transition-colors duration-300">
