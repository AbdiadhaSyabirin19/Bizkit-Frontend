    ...
    <Layout title="Multi Harga">
      <div className="max-w-6xl mx-auto p-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-xl font-bold text-gray-800">Multi Harga</h1>
          </div>
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-[#E9ECEF] border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 font-bold text-gray-700">Nama Kategori Harga Tambahan</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? (
                ...
                <tr><td colSpan="3" className="px-6 py-10 text-center text-gray-400">Tidak ada data harga tambahan</td></tr>
              ) : (
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-4">
                        {can('multi_harga', 'edit') && (
                          <button onClick={() => navigate(`/price-categories/${getID(row)}/edit`)} className="text-gray-600 hover:text-blue-500 transition">
        ...
        {can('multi_harga', 'create') && (
          <button 
            onClick={() => navigate('/price-categories/add')}
