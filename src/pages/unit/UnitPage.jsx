          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-[#E9ECEF] border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 font-bold text-gray-700">Satuan</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? (
                ...
                <tr><td colSpan="3" className="px-6 py-10 text-center text-gray-400">Tidak ada data satuan</td></tr>
              ) : (
                  ...
                  <tr key={getID(row)} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-4">
                        {can('units', 'edit') && (
                          <button onClick={() => navigate(`/units/${getID(row)}/edit`)} className="text-gray-600 hover:text-blue-500 transition">
