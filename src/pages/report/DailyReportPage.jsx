                  ...
                  {data?.sales?.length > 0 && (
                    <tfoot className="bg-gray-50 border-t-2 border-gray-200">
                      <tr>
                        ...
                        <td className="px-4 py-3 text-xs font-bold text-gray-600 dark:text-zinc-400 dark:text-zinc-500">{formatRp((data?.sales || []).reduce((s, sale) => s + (sale.subtotal || sale.Subtotal || 0), 0))}</td>
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {arusKas.length > 0 ? arusKas.map((k, idx) => (
                      <tr key={idx} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-xs text-gray-600 dark:text-zinc-400 dark:text-zinc-500">{k.transaksi}x</td>
              ...
              <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-gray-50">
                    <span className="text-sm text-gray-600 dark:text-zinc-400 dark:text-zinc-500">💵 Total Pemasukan</span>
                    <span className="font-semibold text-emerald-600">{formatRp(data?.total_omzet)}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-50">
                    <span className="text-sm text-gray-600 dark:text-zinc-400 dark:text-zinc-500">🏷️ Total Diskon</span>
                        ...
                        <div key={p.name}>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <div className="flex items-center gap-4">
                              <span className="text-xs text-gray-500 dark:text-zinc-400 dark:text-zinc-500">{p.qty} qty</span>
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {topProducts.map((p, idx) => (
                        <tr key={p.name} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 text-xs text-gray-500 dark:text-zinc-400 dark:text-zinc-500">
